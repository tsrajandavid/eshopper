...
export default function ListedProducts(getAllProducts: any) {
  const [productsList, setProductsList] = useState<any>(getAllProducts.getAllProducts)
  return (
    <>
              ...
              <div className="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div className="card product-item border-0 mb-4">
                  ...
                  <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                    <h6 className="text-truncate mb-3 px-2">{item.title}</h6>
